...
public class MarksLoader {
    ...
    public String[] accessOptions(String cookie,String sessionValue) throws MarksError {//If sessionValue not to be given it is null
        ...
        try {
            obj = new URL(home + "/marksstatus.aspx");
        ...
        try {
            ...
            if (responseCode == HttpURLConnection.HTTP_OK) { // success
                ...
                if (responseCode == HttpURLConnection.HTTP_OK) {
                    ...
                    PrintStream file =new PrintStream(context.openFileOutput("marks_temp.html", Context.MODE_PRIVATE));
    ...
    public MarksLoader(Context context,Progressable progressable)
    {
        super();
        this.context=context;
